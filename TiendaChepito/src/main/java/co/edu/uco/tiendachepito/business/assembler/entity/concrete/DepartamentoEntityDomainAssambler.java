...
public final class DepartamentoEntityDomainAssambler  implements EntityDomainAssembler<DepartamentoDomain, DepartamentoEntity> {

        @Override
        public final DepartamentoDomain ensamblarDominio(final DepartamentoEntity entity) {
            var departamentoEntityTemp = ObjectHelper.getObjectHelper().getDefault(entity, DepartamentoEntity.build(0));
    ...
    public final DepartamentoEntity ensamblarEntidad(final DepartamentoDomain dominio) {
        ...
        return DepartamentoEntity.build(departamentoDomainTemp.getId(), departamentoDomainTemp.getNombre(),);
    }
}
